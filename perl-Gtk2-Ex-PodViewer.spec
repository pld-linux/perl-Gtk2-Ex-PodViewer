...
Summary(pl.UTF-8):	Widget Gtk2 do wyświetlania plików POD (Plain old Documentation)
Name:		perl-%{pdir}-%{pnam}
Version:	0.18
Release:	1
# same as perl
...
# Source0-md5:	09faddfde815e88e49d4ba61fd5469b9
...
Widget Gtk2 do wyświetlania plików POD (Plain old Documentation).
